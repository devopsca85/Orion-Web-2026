...
import { createFooterLink } from '@/lib/admin/footer-link-actions'
...
export default async function NewFooterLinkPage() {
  ...
  return (
    <>
      <AdminTopBar title="Add Footer Link" user={session!.user} />
      <div className="p-6 max-w-2xl">
        ...
        <form action={createFooterLink} className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input id="label" name="label" type="text" required placeholder="About Us" className={inputClass} />
              </div>
              <div>
                <label htmlFor="group" className="block text-sm font-medium text-slate-700 mb-1">
                  Group <span className="text-red-500">*</span>
                </label>
                <input id="group" name="group" type="text" required placeholder="Company" className={inputClass} />
            ...
            <div>
              ...
              <input id="href" name="href" type="text" required placeholder="/about" className={inputClass} />
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select id="openInNew" name="openInNew" className={inputClass}>
