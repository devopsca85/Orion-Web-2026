...
import { updateTestimonial } from '@/lib/admin/testimonial-actions'
...
export default async function EditTestimonialPage({ params }: Props) {
  ...
  return (
    <>
      <AdminTopBar title="Edit Testimonial" user={session!.user} />
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input id="name" name="name" type="text" required defaultValue={testimonial.name} className={inputClass} />
              </div>
              <div>
                <label htmlFor="rating" className="block text-sm font-medium text-slate-700 mb-1">
                  Rating
                </label>
                <select id="rating" name="rating" defaultValue={String(testimonial.rating)} className={inputClass}>
            ...
            <div>
              ...
              <input id="avatar" name="avatar" type="text" defaultValue={testimonial.avatar ?? ''} className={inputClass} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input id="sortOrder" name="sortOrder" type="number" defaultValue={testimonial.sortOrder} min={0} className={inputClass} />
              </div>
